...
import { LogIn, Monitor, Calendar, Users, Clock, Sparkles } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  return (
    <div className={styles.adminWrapper} role="main" aria-label="KonfiDayPlaner Startseite">
      <FlipchartBackground />
      ...
      <main className={styles.adminContent} style={{ 
        ...
        <div style={{
          ...
          <p style={{ 
            ...
            Dein digitaler Begleiter für Jugendgruppen-Events.<br />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Erstelle und verwalte Events mit detaillierten Tagesplänen für deine Jugendgruppe.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Registriere Geräte als Display und zeige Tagespläne in Echtzeit an.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Handgezeichnetes Design für eine freundliche und jugendliche Atmosphäre.
            </p>
          </div>
        </div>
      </main>
